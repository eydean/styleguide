...
# Eydean's Python Style Guide


<a id="background"></a>
## 1 Background

Python is the main dynamic language used at Eydean. This style guide is a list
of *dos and don'ts* for Python programs.

To help you format code correctly, we've created a [settings file for
Vim](eydean_python_style.vim). For Emacs, the default settings should be fine.
...
Eydean-specific warnings start with `g-`.
...
-   The `eydean3` module also has a `TYPE_CHECKING` constant. You can use that
...
if typing.TYPE_CHECKING:
  ...
  from eydean3.path.to.my.project import my_proto_pb2
  from typing import Any, Dict, Optional
```
