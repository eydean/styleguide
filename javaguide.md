...
- [Recommended reading](https://github.com/eydean/styleguide/blob/master/javaguide.md#recommended-reading)
- [Coding style](https://github.com/eydean/styleguide/blob/master/javaguide.md#coding-style)
  - [Formatting](https://github.com/eydean/styleguide/blob/master/javaguide.md#formatting)
  - [Field, class, and method declarations](https://github.com/eydean/styleguide/blob/master/javaguide.md#field-class-and-method-declarations)
  - [Variable naming](https://github.com/eydean/styleguide/blob/master/javaguide.md#variable-naming)
  - [Space pad operators and equals](https://github.com/eydean/styleguide/blob/master/javaguide.md#space-pad-operators-and-equals)
  - [Be explicit about operator precedence](https://github.com/eydean/styleguide/blob/master/javaguide.md#be-explicit-about-operator-precedence)
  - [Documentation](https://github.com/eydean/styleguide/blob/master/javaguide.md#documentation)
  - [Imports](https://github.com/eydean/styleguide/blob/master/javaguide.md#imports)
  - [Use annotations wisely](https://github.com/eydean/styleguide/blob/master/javaguide.md#use-annotations-wisely)
  - [Use interfaces](https://github.com/eydean/styleguide/blob/master/javaguide.md#use-interfaces)
- [Writing testable code](https://github.com/eydean/styleguide/blob/master/javaguide.md#writing-testable-code)
  - [Fakes and mocks](https://github.com/eydean/styleguide/blob/master/javaguide.md#fakes-and-mocks)
  - [Let your callers construct support objects](https://github.com/eydean/styleguide/blob/master/javaguide.md#let-your-callers-construct-support-objects)
  - [Testing multithreaded code](https://github.com/eydean/styleguide/blob/master/javaguide.md#testing-multithreaded-code)
  - [Testing antipatterns](https://github.com/eydean/styleguide/blob/master/javaguide.md#testing-antipatterns)
- [Avoid randomness in tests](https://github.com/eydean/styleguide/blob/master/javaguide.md#avoid-randomness-in-tests)
- [Best practices](https://github.com/eydean/styleguide/blob/master/javaguide.md#best-practices)
  - [Defensive programming](https://github.com/eydean/styleguide/blob/master/javaguide.md#defensive-programming)
  - [Clean code](https://github.com/eydean/styleguide/blob/master/javaguide.md#clean-code)
  - [Use newer/better libraries](https://github.com/eydean/styleguide/blob/master/javaguide.md#use-newerbetter-libraries)
  - [equals() and hashCode()](https://github.com/eydean/styleguide/blob/master/javaguide.md#equals-and-hashcode)
  - [Premature optimization is the root of all evil](https://github.com/eydean/styleguide/blob/master/javaguide.md#premature-optimization-is-the-root-of-all-evil)
  - [TODOs](https://github.com/eydean/styleguide/blob/master/javaguide.md#todos)
  - [Obey the Law of Demeter](https://github.com/eydean/styleguide/blob/master/javaguide.md#obey-the-law-of-demeter-lod)
  - [Don't Repeat Yourself](https://github.com/eydean/styleguide/blob/master/javaguide.md#dont-repeat-yourself-dry)
  - [Manage threads properly](https://github.com/eydean/styleguide/blob/master/javaguide.md#manage-threads-properly)
  - [Avoid unnecessary code](https://github.com/eydean/styleguide/blob/master/javaguide.md#avoid-unnecessary-code)
  - [The 'fast' implementation](https://github.com/eydean/styleguide/blob/master/javaguide.md#the-fast-implementation)
